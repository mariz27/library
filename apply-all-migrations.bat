@echo off
echo Applying all migrations to align the database with the new structure...
...
php artisan migrate --path=database/migrations/2023_07_24_000005_update_borrowings_table.php

echo Migrations completed.
echo The database has been updated with all required fields.
pause